...
sentences = [
    "I revised calculus all weekend to prepare for the exam.",
    "Cramming past papers late at night makes my brain melt.",
    "The stock market crashed after the surprising earnings call.",
    "I crashed on the sofa as soon as I got home from the exam.",
    "My sourdough bread needs a full day to rise properly.",
    "The bakery in London sells fresh bread every morning.",
    "Training at the gym three times a week has boosted my energy.",
    "Going for a slow walk in the park helps me clear my head.",
    "The NBA is so fun to watch, especially during the playoffs.",
    "Debugging a JavaScript bug at 2 a.m. is not my idea of fun.",
]
