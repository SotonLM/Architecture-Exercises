...
- Retrievals do not do well accross multi-topic queries as they seem to focus on one topic. This is probably because all encodings will have similarity scores that are close together and I'm only retrieving the top 3 results.
